...
/// \ingroup TR
/// \file TR/g4tgeoConfig.C
/// \brief Configuration macro for Geant4 VirtualMC for Example TR
///
/// For geometry defined with Root and selected G4Root navigation

void Config()
{
/// The configuration function for Geant4 VMC for Example TR
...
/// For geometry defined with Root and selected G4Root navigation
  ...
  if (physicsList.Length() > 0) {
    ...
    physicsList = "emStandard";
  }

  // Run configuration
  TG4RunConfiguration* runConfiguration
    = new TG4RunConfiguration("geomRoot", physicsList, "", false, false);
