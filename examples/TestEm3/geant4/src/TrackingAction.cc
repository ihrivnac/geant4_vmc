...
TrackingAction::TrackingAction(G4VUserDetectorConstruction* det,
  G4UserEventAction* evt)
  : fDetector(static_cast<DetectorConstruction*>(det)),
    fEventAct(static_cast<EventAction*>(evt))
{}
 
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void TrackingAction::PreTrackingAction(const G4Track* track )
{
  //get Run
...
void TrackingAction::PostTrackingAction(const G4Track* track )
{
 // energy leakage
