...
/// \file E03/src/MCStack.cxx
/// \brief Implementation of the MCStack class
///
...
//_____________________________________________________________________________
MCStack::MCStack() : fParticles(0), fCurrentTrack(-1), fNPrimary(0)
{
  /// Default constructor
}
...
//_____________________________________________________________________________
void MCStack::PushTrack(Int_t toBeDone, Int_t parent, Int_t pdg,
...
//_____________________________________________________________________________
void MCStack::Print(Option_t* /*option*/) const
{
  /// Print info for all particles.

  cout << "MCStack Info  " << endl;
...
//_____________________________________________________________________________
void MCStack::SetCurrentTrack(Int_t track)
{
...
//_____________________________________________________________________________
Int_t MCStack::GetNprimary() const
{
...
//_____________________________________________________________________________
Int_t MCStack::GetCurrentTrackNumber() const
{
