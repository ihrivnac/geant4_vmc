...
/// \file E03b/src/MCApplication.cxx
...
/// \cond CLASSIMP
ClassImp(VMC::E03::MCApplication)
/// \endcond
...
/// \param title  The MC application description
  ...
  //fCalorimeterSD = new CalorimeterSD("Calorimeter", fDetConstruction);
...
/// \param origin   The source MC application
  ...
  // Create a calorimeter SD
  // fCalorimeterSD
  //   = new CalorimeterSD(*(origin.fCalorimeterSD), fDetConstruction);
...
/// Register stack in the Root manager.
  ...
  if ( fRootManager ) {
    ...
    fRootManager->Register("stack", "VMC::E03::MCStack", &fStack);
  }
}
...
/// TVirtualMC functions (if oldGeometry is selected)
  ...
  if ( ! fOldGeometry ) {
    ...
    DetectorConstructionOld detConstructionOld;
...
//_____________________________________________________________________________
void MCApplication::ConstructSensitiveDetectors()
{
/// Create sensitive detectors and attach them to sensitive volumes

  cout << "MCApplication::ConstructSensitiveDetectors()" << endl;

  CalorimeterSD* calorimeterSD
    = new CalorimeterSD("Calorimeter", fDetConstruction);
