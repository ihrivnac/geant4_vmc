...
/// \file E03a/src/ DetectorConstructionOld.cxx
/// \brief Implementation of the DetectorConstructionOld class
///
...
#include "DetectorConstructionOld.h"

using namespace std;

/// \cond CLASSIMP
ClassImp(VMC::E03::DetectorConstructionOld)
/// \endcond
...
DetectorConstructionOld::DetectorConstructionOld()
  : TObject(),
    fNbOfLayers(0),
    fWorldSizeX(0.),
    fWorldSizeYZ(0.),
...
//_____________________________________________________________________________
void DetectorConstructionOld::ComputeCalorParameters()
{
...
//_____________________________________________________________________________
void DetectorConstructionOld::ConstructMaterials()
{
...
//_____________________________________________________________________________
void DetectorConstructionOld::ConstructGeometry()
{
...
//_____________________________________________________________________________
void DetectorConstructionOld::PrintCalorParameters()
{
...
//_____________________________________________________________________________
void DetectorConstructionOld::SetNbOfLayers(Int_t value)
{
...
//_____________________________________________________________________________
void DetectorConstructionOld::SetDefaultMaterial(const TString& materialName)
{
...
//_____________________________________________________________________________
void DetectorConstructionOld::SetAbsorberMaterial(const TString& materialName)
{
...
//_____________________________________________________________________________
void DetectorConstructionOld::SetGapMaterial(const TString& materialName)
{
/// Set gap material
...
//_____________________________________________________________________________
void DetectorConstructionOld::SetCalorSizeYZ(Double_t value)
{
...
//_____________________________________________________________________________
void DetectorConstructionOld::SetAbsorberThickness(Double_t value)
{
...
//_____________________________________________________________________________
void DetectorConstructionOld::SetGapThickness(Double_t value)
{
...
/*
//_____________________________________________________________________________
void DetectorConstructionOld::UpdateGeometry()
{
